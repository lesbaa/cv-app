...
class SocialProofScene extends Component {
  componentDidMount = async () => {
    await this.props.fetchReferences({ type: SOFT_SKILLS })
    await this.init()
  }
  ...
  render = () => (
    <canvas
      className="SocialProofScene anim-scene"
...
SocialProofScene.defaultProps = {
  ...
  fetchReferences: () => console.log('DevSkillsScene: no "fetchSkills" action passed'),
}
